...
Feel free to jump straight to [examples](/docs/examples/basic),
but make sure to check the main [core function](/docs/reference/createForm) and [validation triggers](/docs/guides/validation-triggers) after.
